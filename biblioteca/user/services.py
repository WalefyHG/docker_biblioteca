    ...
    def post(
        ...
        try:
            with transaction.atomic():
                ...
                status_code, instance = cls.validate_payload(payload=payload)
            ...
            return status.HTTP_400_BAD_REQUEST, {"message": str(error)}
        ...
        **kwargs
        ...
        try:
            with transaction.atomic():
                ...
                instance = cls.repository.put(instance=instance, payload=payload, last_user_id=last_user_id)
                return status.HTTP_200_OK, instance
